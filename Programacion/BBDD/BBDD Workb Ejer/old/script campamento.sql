...
CREATE TABLE campista(
	campista_id INTEGER UNSIGNED UNIQUE NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE actividad(
	actividad_id INTEGER UNSIGNED UNIQUE NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nombre VARCHAR(50) NOT NULL,
...
CREATE TABLE chico_actividad(
    campista_id INTEGER UNSIGNED UNIQUE NOT NULL,
    actividad_id INTEGER UNSIGNED UNIQUE NOT NULL,
    fecha_inicio DATETIME NOT NULL,
    fecha_fin DATETIME NOT NULL,
    observaciones VARCHAR(300),
    FOREIGN KEY (campista_id ) REFERENCES campista (campista_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (actividad_id) REFERENCES actividad (actividad_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    PRIMARY KEY (campista_id, actividad_id, fecha_inicio, fecha_fin, observaciones)
);
SELECT * FROM campista;
